...
class Profile(models.Model):
    ...
    phone = PhoneNumberField(
        null=True, blank=True, unique=True, verbose_name="Telefon (+48XXXXXXXXX)"
    )
...
class ProfileInCup(models.Model):
    ...
    name = models.CharField(
        max_length=30, blank=False, verbose_name="nazwa gracza", default=""
    )
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="user_in_profile_cup", null=True
    )
    team = models.CharField(max_length=20)
    cup = models.ForeignKey(
        Cup, on_delete=models.CASCADE, related_name="cup_in_profile_cup"
    )
    ...
    goals_scored = models.PositiveSmallIntegerField(
        verbose_name="Bramki zdobyte", default=0
    )
    goals_losted = models.PositiveSmallIntegerField(
        verbose_name="Bramki stracone", default=0
    )
    ...
    group = models.ForeignKey(
        Cup, on_delete=models.CASCADE, related_name="group", default="", null=True
    )
